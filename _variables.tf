...
variable "create_vm_backup" {
  description = "Set to true to create VM backup resources"
  type        = bool
  default     = false
}

variable "create_file_share_backup" {
  description = "Set to true to create file share backup resources"
  type        = bool
  default     = false
}